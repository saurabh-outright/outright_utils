...
function outright_post_install_msg($plug_in,$web_link='https://outrightcrm.com/'){

$msg ="<h2> Thanks for using our ".$plug_in." Module , we commit best services<br/>Please feel free to reach us at sales@outrightcrm.com if any problem or help required!!</h2>";

$msg .="<h3> Please find more information about this plugin <a href='".$web_link."' target='_blank'> here </a>";
echo $msg;
}